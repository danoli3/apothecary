...
- **FreeImage** 3.19.10 → 3.19.11 (#551), then 3.19.12–3.19.16 (3.19.16: OpenEXR 3.3.14 ARM64EC fix, LibRaw 0.22.2); OpenEXR/WebP/LibRaw enabled on all types (JXR remains Windows-only)
