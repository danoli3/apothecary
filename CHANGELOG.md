...
- **FreeImage** 3.19.10 → 3.19.11 (#551), then 3.19.12, 3.19.13, 3.19.14, then 3.19.15 (ICO/PSD heap-overflow CVEs); OpenEXR/WebP/LibRaw enabled on all types (JXR remains Windows-only)
