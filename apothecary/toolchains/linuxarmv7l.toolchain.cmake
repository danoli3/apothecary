# Raspberry Pi OS 32-bit ARMv7 toolchain (ARCH=armv7l).
# Official builds use host GCC 10 + a bookworm armhf SYSROOT.
...
if(NOT DEFINED SYSROOT)
    ...
    elseif(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "armv7l")
        ...
        set(SYSROOT "/opt/rpi-armv7l-sysroot")
...
elseif(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "armv7l" AND SYSROOT STREQUAL "/")
...
if(NOT CMAKE_C_COMPILER)
    message(FATAL_ERROR "C compiler not found for Raspberry Pi armv7l (need arm-linux-gnueabihf-gcc-10)")
endif()
if(NOT CMAKE_CXX_COMPILER)
    message(FATAL_ERROR "C++ compiler not found for Raspberry Pi armv7l (need arm-linux-gnueabihf-g++-10)")
endif()
...
set(RPI_ARCH_FLAGS "-march=armv7-a -mtune=${M_CPU} -mfpu=neon-vfpv4 -mfloat-abi=hard -fPIC")
...
message(STATUS "Raspberry Pi armv7l toolchain")
