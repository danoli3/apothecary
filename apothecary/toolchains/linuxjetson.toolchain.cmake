...
if(NOT DEFINED M_CPU)
    if(DEFINED ENV{M_CPU})
        set(M_CPU $ENV{M_CPU}) / set(M_CPU cortex-a78ae) # For Orin devices
        message(STATUS "M_CPU is ${M_CPU}")
    else()
        set(M_CPU cortex-a57) # Common Jetson CPU  
        message(STATUS "Defaulting M_CPU to ${M_CPU}")
    endif()
endif()
...
if(NOT DEFINED TOOLCHAIN_ROOT)
    if(DEFINED ENV{TOOLCHAIN_ROOT})
        ...
        set(TOOLCHAIN_ROOT jetson) # Default value
        message(WARNING "TOOLCHAIN_ROOT not specified. Defaulting to TOOLCHAIN_ROOT=jetson")
    endif()
endif()
...
if(NOT DEFINED SYSROOT)
    if(DEFINED ENV{SYSROOT})
        ...
        set(SYSROOT jetson) # Default value
        message(WARNING "SYSROOT not specified. Defaulting to SYSROOT=jetson")
    endif()
endif()


set(CMAKE_FIND_ROOT_PATH ${SYSROOT} CACHE STRING "" FORCE)
set(CMAKE_SYSROOT ${SYSROOT}/aarch64-buildroot-linux-gnu/sysroot CACHE STRING "" FORCE)
...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${CFLAGS} --sysroot=${CMAKE_SYSROOT} -fPIC ${EXTRA_LINKS} -mcpu=${M_CPU}") 
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CFLAGS} --sysroot=${CMAKE_SYSROOT} -fPIC ${EXTRA_LINKS} -mcpu=${M_CPU}")
