...
|---------|------------------|-----------------|--------|---------------|--------------|
| **angle** | `2026.08.13` (`7e8009eb2c42996fe6e7337bf8d12e1cfe4a1b80`) | google/angle GN; GLES→D3D11 on VS, GLES→Metal on osx/ios/tvos/catos/xros. Opt-in `latest-modular` (not core CI). | pinned-dev | https://github.com/google/angle | `apothecary/formulas/angle/angle.sh` |
