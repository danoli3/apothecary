...
Core OF formulas currently in `apothecary/formulas`:

assimp, boost, brotli, cairo, curl, fmod, fmodex, fmt, FreeImage, freetype, glew, glfw, glm, gstreamer, json, kiss, libpng, libssh2, libusb, libxml2, metalangle, opencv, openssl, pixman, poco, portaudio, pugixml, rtAudio, shaderc, svgtiny, tess2, uriparser, utf8, videoInput, zlib

Run `./apo formulas` (or `apothecary/apothecary -h`) to list what's available in your checkout — this list changes as formulas are added.
